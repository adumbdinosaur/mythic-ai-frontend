...
const variantClasses: Record<Variant, string> = {
  primary:
    "bg-red-700 hover:bg-red-800 text-white border border-transparent focus-visible:ring-red-500",
  secondary:
    "bg-amber-600 hover:bg-amber-700 text-white border border-transparent focus-visible:ring-amber-500",
  ghost:
